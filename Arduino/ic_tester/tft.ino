...
void startScreen()
{
  ...
  tft.println("Edited By");
  tft.setCursor(85, 160);
  tft.setTextColor(WHITE);  tft.setTextSize(3);
  tft.println("Ian Green");
...
void modeScreen()
{
  ...
  buttons[0].initButton(&tft, 150, 110, 160, 40, BLACK, BLUE, WHITE, "Auto", 4);
  buttons[0].drawButton();

  buttons[1].initButton(&tft, 150, 160, 160, 40, BLACK, YELLOW, BLACK, "Manual", 4);
  buttons[1].drawButton();

  buttons[2].initButton(&tft, 150, 210, 160, 40, BLACK, GREEN, BLACK, "Prog", 4);
